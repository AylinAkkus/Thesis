...
These comparisons demonstrate that our focused approach to data pool construction and RL training enables a 30B parameter model to outperform both specialized and general-purpose models that are larger or similarly sized.
...
These results validate our approach to data pool construction, filtering, and RL training, demonstrating that careful attention to data quality and training methodology yields significant improvements in grounding model capabilities.
