...
ScreenSpot-Pro~\cite{screenspot} is a benchmark for GUI grounding on professional high-resolution computer interfaces. It tests the model's ability to locate UI elements in complex, realistic application interfaces.
...
OS-World-G~\cite{osworld} is a grounding benchmark that tests models on diverse operating system interfaces. The benchmark includes a refined version that corrects annotation errors in the original benchmark.
