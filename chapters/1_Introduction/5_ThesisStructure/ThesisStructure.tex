...
\begin{description}
    \item[Chapter 2 -- Methodology] Presents data curation, followed by a data filtering pipeline, the collection of supplemental data to address gaps in the dataset, and the training of Gelato-30B-A3B.
