...
Inspired by \cite{gta1} IoU overlap.
...
Inspired by \cite{segui} difficulty filtering. However, they only sample too easy samples and not too hard samples.
...
\begin{tabular}{lccc}
\hline
Data Pool & SS Pro & SS V2 & Showdown Clicks \\
 & Accuracy & Accuracy & Accuracy \\
\hline
All Data Sources & 45.22\% & 91.05\% & 66.97\% \\
Remove Bottom 3 on SS Pro & 45.03\% & 90.14\% & 68.94\% \\
(SeeClick, Pixmo Points, UGround) & & & \\
Remove Worst one on SS Pro & 44.78\% & 90.79\% & 67.68\% \\
(Pixmo Points) & & & \\
\hline
\end{tabular}
...
\begin{tabular}{lccc}
\hline
\textbf{Configuration} & \textbf{SS Pro} & \textbf{SS V2} & \textbf{Showdown} \\
 & \textbf{Acc.} & \textbf{Acc.} & \textbf{Clicks Acc.} \\
\hline
10k (w/o replacement) & 45.22\% & 91.05\% & 66.97\% \\
10k + best prompt & 46.23\% & --- & 67.50\% \\
20k (w/ replacement) & 45.41\% & 90.66\% & 66.61\% \\
20k (w/o replacement) & 46.55\% & 90.27\% & 67.14\% \\
35k (w/o replacement) & 47.18\% & 90.66\% & 69.12\% \\
80k + improvements & 49.65\% & 90.79\% & 68.40\% \\
\hline
\end{tabular}
\end{table}
