...
After assembling the data pool (Section~\ref{sec:data_curation}) and filtering it (Section~\ref{sec:data_filtering}), we evaluate performance and look for systematic weaknesses of the models to identify underrepresented areas of the training data.
