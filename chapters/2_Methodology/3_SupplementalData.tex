...
We normalize, resize and convert the UI Vision \cite{nayak2025uivision} and JEDI \cite{2025jedi} datasets to the same format as the other datasets. Importantly, we do not apply the entire filtering pipeline like before to these datasets.
